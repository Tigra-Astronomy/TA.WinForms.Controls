...
// 
// File: LEDIndicator.cs  Last modified: 2016-09-12@23:15 by Tim Long
...
namespace TA.WinFormsControls
    ...
    public sealed class LedIndicator : UserControl, ICadencedControl
        ...
        /// </summary>
        [Category("LED Properties"), DefaultValue(TrafficLight.Green), Description(
        ...
        /// </summary>
        [Category("LED Properties"), Description("Sets the text that appears next to the LED indicator.")]
        ...
        /// </summary>
        [Category("LED Properties"), DefaultValue(true),
         Description(
        ...
        /// </remarks>
        [Category("LED Properties"), DefaultValue(CadencePattern.SteadyOn), Description(
        ...
        public void CadenceUpdate(bool newstate)
            {
            if (newstate == active)
                return; // Don't do anything if state hasn't changed.
            if (disposed)
